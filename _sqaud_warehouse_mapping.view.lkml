    ...
    sql:
      ...
      FROM (
        VALUES
          ...
          ('SEARCH_L_24USD_PER_HOUR', 'SEARCH'),
          ('SEARCH_M_12USD_PER_HOUR', 'SEARCH'),
          ('SEARCH_S_6USD_PER_HOUR', 'SEARCH'),
          ('SEARCH_XL_48USD_PER_HOUR', 'SEARCH'),
          ('SEARCH_XS_3USD_PER_HOUR', 'SEARCH'),
          ('SEARCH_XXL_96USD_PER_HOUR', 'SEARCH'),
          ('SUPPORT_L_24USD_PER_HOUR', 'SUPPORT'),
          ('SUPPORT_M_12USD_PER_HOUR', 'SUPPORT'),
          ('SUPPORT_S_6USD_PER_HOUR', 'SUPPORT'),
          ('SUPPORT_XL_48USD_PER_HOUR', 'SUPPORT'),
          ('SUPPORT_XS_3USD_PER_HOUR', 'SUPPORT'),
          ('SUPPORT_XXL_96USD_PER_HOUR', 'SUPPORT')
